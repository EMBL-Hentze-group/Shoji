...
class Interval(SortedSet):
    ...
    def __and__(self, other: "Interval") -> "Interval":
        ...
        for sstart, sstop in self:
            for ostart, ostop in other:
                if overlap := self._intersects(sstart, sstop, ostart, ostop):
                    intersections.add(overlap[0], overlap[1])
    ...
    def __or__(self, other: "Interval") -> "Interval":
        ...
        if self.empty and other.empty:
            ...
            for sstart, sstop in self:
                unions.add(sstart, sstop)
            for ostart, ostop in other:
                unions.add(ostart, ostop)
            return unions
